...
import { apple, bill, google, woman2 } from "../assets";
...
const Billing = () => (
  <section id="product" className={layout.sectionReverse}>
    <div className={layout.sectionImgReverse}>
      <Image src={woman2} alt="billing" className="w-[100%] h-[100%] relative z-[5] rounded-lg" />
    ...
    <div className={layout.sectionInfo}>
      <h2 className={styles.heading2}>
        Easily control your <br className="sm:block hidden" /> Learning Curve
      </h2>
